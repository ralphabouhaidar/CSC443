...
<head>
    ...
    <script src="../../js/crud/employees.js"></script>
                            ...
                            <tbody>
                                <?php
                                    if(isset($_GET["search_txt"]))
                                        $sql = "SELECT e.emp_first, e.emp_last, e.emp_email, e.address, e.emp_phone, e.position, e.Salaries FROM Employees e WHERE e.emp_first LIKE \"".$_GET["search_txt"]."%\" OR e.emp_last LIKE \"".$_GET["search_txt"]."%\" OR e.emp_email LIKE \"".$_GET["search_txt"]."%\"";
                                    
                                    else
                                        $sql = "SELECT e.emp_first, e.emp_last, e.emp_email, e.address, e.emp_phone, e.position, e.Salaries FROM Employees e";
                                    ...
                                    if($entries > 0) /*if the query returns a non-empty result*/
                                    {
                                        while($row = $result->fetch_assoc())
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="salary"><?= $row["Salaries"]."LL"; ?></td>
